        ...
        <CardContent className="p-8 space-y-8">
          ...
          <div className="space-y-6">
            ...
            {assets.map((asset, index) => (
              <div key={index} className="glass rounded-2xl p-6 space-y-4 border border-yellow-500/10 hover:border-yellow-500/20 transition-all duration-300 hover-lift stagger-animation relative">
