        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12">
          <div className="max-w-xl">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Sua plataforma inteligente para análise e otimização de carteiras de investimento no mercado brasileiro.
            </p>
            
            <div className="bg-gradient-to-r from-yellow-500/10 to-amber-500/10 border border-yellow-500/20 rounded-2xl p-6 mb-8">
              <h3 className="text-lg font-semibold text-yellow-400 mb-3">🎯 O que você pode fazer:</h3>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-yellow-400"></div>
                  Analisar diversificação da sua carteira
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-yellow-400"></div>
            ...
            <div className="glass-dark rounded-3xl p-8 border border-yellow-500/20 shadow-2xl backdrop-blur-xl">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">
                  {isLogin ? 'Entre na sua conta para analisar sua carteira' : 'Comece a otimizar seus investimentos hoje'}
                </p>
                {!isLogin && (
                  <p className="text-yellow-400 text-sm mt-2 font-medium">
                    ✨ Cadastro gratuito • Análise imediata • Sem compromisso
                  </p>
                )}
              </div>
              ...
              <div className="space-y-6">
                <Button
                  disabled={true}
                  className="w-full bg-gray-600 text-gray-400 cursor-not-allowed border-0 flex items-center justify-center gap-3 h-12 font-medium opacity-60"
                >
